...
export default function ProductUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = productRecord
      ? { ...initialValues, ...productRecord, categoryID, genreID }
      : initialValues;
  ...
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ...
        : productModelProp;
      const categoryIDRecord = record ? record.categoryID : undefined;
      const categoryRecord = categoryIDRecord
        ? (
            await API.graphql({
              query: getCategory,
              variables: { id: categoryIDRecord },
            })
          )?.data?.getCategory
        : undefined;
      setCategoryID(categoryIDRecord);
      setSelectedCategoryIDRecords([categoryRecord]);
  ...
  React.useEffect(resetStateValues, [productRecord, categoryID, genreID]);
